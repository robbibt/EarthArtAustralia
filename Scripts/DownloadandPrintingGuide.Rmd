...
output: pdf_document
params:
  dropbox_dir: D:/Dropbox/EarthArtAustralia
...
split_path = strsplit(data_sub$file_link, "/")[[1]] # split_path = strsplit("/Australia/melbourne_city_highres.png", "/")[[1]]
image_link = paste0("D:/Dropbox/EarthArtAustralia", "/", split_path[2], "/", 
...
Finally, if you like the `r if( length(links_n) > 1 ){ "maps" } else { "map" }` I'd really love it if you could leave me a quick review on Etsy (click ["You > Purchases and Reviews"](https://www.etsy.com/au/your/purchases?ref=hdr_user_menu)). Send me a message if you do and I'll give you **any ready-made map of your choice for free**! 
...
**Facebook:** <https://www.facebook.com/EarthArtAustralia/>  
